package com.fr.swift.benchmark.load;
...
public class BatchIngestBenchmark {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Options opt = new OptionsBuilder()
                .include(BatchIngestBenchmark.class.getSimpleName())
                .forks(1)
                .build();
        new Runner(opt).run();
    }
    ...
    public void batchIngest(Blackhole bh) throws Exception {
        SwiftMetaDataService service = SwiftContext.get().getBean(SwiftMetaDataService.class);
